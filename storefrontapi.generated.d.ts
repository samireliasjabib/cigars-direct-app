...
export type LightweightCollectionQueryVariables = StorefrontAPI.Exact<{
  handle?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['String']['input']>;
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type LightweightCollectionQuery = {
  collection?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'handle'> & {
      image?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Image, 'url' | 'id'>>;
    }
  >;
};
...
export type ProductContentFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle'
> & {
  media: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query lightweightCollection($handle: String, $country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      handle\n      image{\n        url\n        id\n      }\n    }\n  }\n': {
    return: LightweightCollectionQuery;
    variables: LightweightCollectionQueryVariables;
  };
